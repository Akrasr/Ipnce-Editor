...
{
    internal class IpnceAnimControl : ElementControl
    {
        Anim obj;

        public IpnceAnimControl(GroupBox box) : base(box) { }
        public IpnceAnimControl(GroupBox box, Anim anim) : base(box) { obj = anim; }
        public void SetAnim(Anim anim) { obj = anim; }
